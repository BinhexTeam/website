odoo.define("website_recaptcha_v2_form.s_website_form", function (require) {
    "use strict";
    ...
    publicWidget.registry.s_website_form.include({
        send: async function (e) {
            ...
            if (this.$target.find("div.s_website_form_recaptcha_v2").length > 0) {
                form_values.recaptcha_enabled = true;
            }
            ...
            ajax.post(
                ...
                .then(async function (data) {
                    ...
                    if (!result_data.id) {
                        ...
                        self.update_status(
                            "error",
                            result_data.error ? result_data.error : false
                        );
